        ...
        <section id="contact">
            ...
            <div className="content">
                ...
                <div className="contacts">
                    <ContactItem 
                        defaultIconSrc = '../assets/icons/call_24dp_F_FILL0_wght400_GRAD0_opsz24.svg'
                        hoverIconSrc = '../assets/icons/call_24dp_228FCE_FILL1_wght400_GRAD0_opsz24.svg'
                        contactText = '06 30 629 0793'
                        contactHref = 'tel:+36306290793'
                    />

                    <ContactItem 
                        defaultIconSrc = '../assets/icons/thumb_up_24dp_F_FILL0_wght400_GRAD0_opsz24.svg'
                        hoverIconSrc = '../assets/icons/thumb_up_24dp_FFFFFF_FILL1_wght400_GRAD0_opsz24.svg'
                        contactText = 'Kövess Facebookon!'
                        contactHref = 'https://www.facebook.com/profile.php?id=61577473041862'
                    />

                    <ContactItem 
                        defaultIconSrc = '../assets/icons/mail_24dp_F_FILL0_wght400_GRAD0_opsz24.svg'
                        hoverIconSrc = '../assets/icons/mail_blue.svg'
